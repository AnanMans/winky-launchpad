...
// Pull name / symbol / logo from Supabase
...
const symbol: string = ((coin?.ticker ?? "WINKY").toUpperCase()).slice(0, 10);
    // Metadata JSON URL (served by your separate /api/metadata route)
    ...
    console.log('[meta v3] ok', { sig, metadataPda: metadataPda.toBase58(), uri });
